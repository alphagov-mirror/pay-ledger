...
public class PayoutServiceTest {
    ...
    public void shouldReturnAPaginatedPayoutSearchResponse() {
        ...
        assertThat(response.getPaginationBuilder().getSelfLink().getHref(), is("http://example.com/v1/payout?gateway_account_id=12345&page=1&display_size=500"));
        assertThat(response.getPaginationBuilder().getFirstLink().getHref(), is("http://example.com/v1/payout?gateway_account_id=12345&page=1&display_size=500"));
        assertThat(response.getPaginationBuilder().getLastLink().getHref(), is("http://example.com/v1/payout?gateway_account_id=12345&page=1&display_size=500"));
        assertThat(response.getPaginationBuilder().getLastLink().getHref(), is("http://example.com/v1/payout?gateway_account_id=12345&page=1&display_size=500"));
