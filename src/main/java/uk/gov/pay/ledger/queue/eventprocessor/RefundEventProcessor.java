...
public class RefundEventProcessor extends EventProcessor {
    ...
    public void process(Event event) {
        ...
        if (isNotBlank(refundEventDigest.getParentResourceExternalId())) {
            ...
            mayBePaymentEventDigest.ifPresent(paymentEventDigest -> {
                Map<String, Object> fieldsFromPayment = getFieldsFromOriginalPayment(paymentEventDigest);
        ...
        mayBePaymentEventDigest.ifPresent(paymentEventDigest -> {
            ...
            refundTransactionEntity.setFieldsFromOriginalPayment(paymentTransactionEntity);
        });
    ...
    private Map<String, Object> getFieldsFromOriginalPayment(EventDigest paymentEventDigest) {
